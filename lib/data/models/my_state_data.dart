class MyStateData {
  ...
  set todayConfirmed(int todayConfirmed) =>
      this._todayConfirmed = todayConfirmed;
  set todayRecovered(int todayRecovered) =>
  ...
  String toString() {
    String data = "state: " +
        ...
        _recovered.toString() +
        ", todayConfirmed:" +
        _todayConfirmed.toString() +
        ", todayRecovered:" +
        _todayRecovered.toString() +
        ", todayDeaths: " +
        _todayDeaths.toString() +
        ", todayActive: " +
        _todayActive.toString();
    return data;
  }
}
